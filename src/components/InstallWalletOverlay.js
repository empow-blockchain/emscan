...
const InstallWalletOverlay = props => {
    return (
        <div className="install-wallet-overlay">
            ...
            <a className="btn btn-install-wallet" href="https://chrome.google.com/webstore/detail/empow-wallet/nlgnepoeokdfodgjkjiblkadkjbdfmgd" target="_blank" rel="noopener noreferrer"><img src={ChromeLogo} alt="ChromeLogo"></img>Install Wallet Extension</a>
